...
urlpatterns = [
    ...
    path("users/imports/errors/", views.user_import_errors, name="user_import_errors"),
    ...
    path("customers/imports/errors/", views.customer_import_errors, name="customer_import_errors"),
    ...
    path("suppliers/imports/errors/", views.supplier_import_errors, name="supplier_import_errors"),
